...
const ModalInfoTurno = ({ isOpen, onClose, turnoData }) => {
  ...
  console.log('=== DATOS DEL TURNO EN MODAL ===');
  console.log('turnoData completo:', turnoData);
  console.log('turnoData.tipo:', turnoData.tipo);
  console.log('typeof turnoData.tipo:', typeof turnoData.tipo);
  console.log('===========================');
      ...
      <div className="bg-white rounded-lg max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        {canManageTurno && (
          <div className="flex justify-end space-x-3 p-6 border-t bg-gray-50">
            ...
            <button 
              onClick={() => {
                // TODO: Implementar cancelación de turno
                console.log('Cancelar turno:', turnoData.id_turno);
              }}
            ...
            {turnoData.tipo !== 'periodico' && (
              <button 
                onClick={() => {
                  ...
                  console.log('Reprogramar turno:', turnoData.id_turno);
                }}
