...
import {
	createTurnoPeriodico,
	getProfesionalById,
	getProfesionalDisponibilidad,
} from '../../../services/bookingService';

const SolicitarTurnoPeriodicoPage = () => {
	...
	const fetchProfesional = async () => {
		try {
			const prof = await getProfesionalById(profesionalId);
			setProfesional(prof);
		} catch (e) {
	...
	const fetchDisponibilidad = async () => {
		try {
			const data = await getProfesionalDisponibilidad(profesionalId);
...
export default SolicitarTurnoPeriodicoPage;
