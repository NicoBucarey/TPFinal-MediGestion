...
import ExcepcionesCalendario from '../components/ExcepcionesCalendario';
import useDisponibilidad from '@/hooks/useDisponibilidad';

const GestionDisponibilidadPage = () => {
  ...
  const handleGuardar = async () => {
    try {
      ...
      console.error('Error al guardar la configuración:', saveError);
    }
  };
...
export default GestionDisponibilidadPage;
